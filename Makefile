##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.19.2] date: [Sun May 07 18:55:20 PDT 2023] 
##########################################################################################################################
...
# Build path
BUILD_DIR = build
CMSIS_5 := Drivers/CMSIS
CMSIS_DSP := $(CMSIS_5)/DSP
...
# libraries
LIBS = -lc -lm -lnosys 
LIBDIR = -LDrivers/CMSIS/DSP/Lib/ARM/arm_cortexM4l_math.lib
...
flash: all
	openocd -f interface/stlink.cfg \
			-f target/stm32l4x.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"
